...
namespace RobotGui {
    ...
    public:
         ...
         */
        explicit Theme(Themes::Type type);
         ...
         */
        void setTheme(enum Themes::Type themeType);

        /**
         * Returns the current theme
         * @return current theme
         */
        Themes::Type getTheme();
         ...
         */
        static std::string getThemeName(Themes::Type themeType);
    ...
    private:
        ...
        Themes::Type currentTheme;
        std::map<Themes::Type, Themes::Format> stringFormats;
        std::map<Themes::Type, bool> themeIsLight;
    };
}
